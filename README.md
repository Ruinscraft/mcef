...
```
dependencies {
    modCompileOnly 'com.cinemamod:mcef:2.1.6-1.21'
    modRuntimeOnly 'com.cinemamod:mcef-fabric:2.1.6-1.21'
}
```
...
```
dependencies {
    compileOnly fg.deobf('com.cinemamod:mcef:2.1.6-1.21')
    runtimeOnly fg.deobf('com.cinemamod:mcef-neoforge:2.1.6-1.21')
}
```
